...
export const generateColorTokens = (
  ...
  return {
    ...
    "select--primary--trigger--border-color-normal": "$gray-100",
    ...
    "select--secondary--trigger--border-color-normal": "$gray-100",
    ...
    "select--accent--trigger--border-color-normal": "$gray-100",
    ...
    "select--error--trigger--border-color-normal": "$gray-100",
