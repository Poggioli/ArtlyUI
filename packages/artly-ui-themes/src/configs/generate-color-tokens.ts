...
export const generateColorTokens = (
  ...
  return {
    ...
    "select--primary--trigger--border-color-normal": "$gray-80",
    "select--primary--trigger--border-color-hover": "$primary-200",
    "select--primary--trigger--border-color-focus": "$primary-90",
    "select--primary--trigger--border-color-disabled": "$gray-60",
    ...
    "select--secondary--trigger--border-color-normal": "$gray-80",
    "select--secondary--trigger--border-color-hover": "$secondary-200",
    "select--secondary--trigger--border-color-focus": "$secondary-90",
    "select--secondary--trigger--border-color-disabled": "$gray-60",
    ...
    "select--accent--trigger--border-color-normal": "$gray-80",
    "select--accent--trigger--border-color-hover": "$accent-200",
    "select--accent--trigger--border-color-focus": "$accent-90",
    "select--accent--trigger--border-color-disabled": "$gray-60",
    ...
    "select--error--trigger--border-color-normal": "$gray-80",
    "select--error--trigger--border-color-hover": "$error-200",
    "select--error--trigger--border-color-focus": "$error-90",
    "select--error--trigger--border-color-disabled": "$gray-60",
    ...
    "input--unstyled--border-color-hover": "$gray-200",
    "input--unstyled--border-color-focus": "$gray-300",
    "input--unstyled--border-color-disabled": "$gray-60",
    ...
    "input--primary--border-color-normal": "$gray-80",
    "input--primary--border-color-hover": "$primary-200",
    "input--primary--border-color-focus": "$primary-90",
    "input--primary--border-color-disabled": "$gray-60",
    ...
    "input--secondary--border-color-normal": "$gray-80",
    "input--secondary--border-color-hover": "$secondary-200",
    "input--secondary--border-color-focus": "$secondary-90",
    "input--secondary--border-color-disabled": "$gray-60",
    ...
    "input--accent--border-color-normal": "$gray-80",
    "input--accent--border-color-hover": "$accent-200",
    "input--accent--border-color-focus": "$accent-90",
    "input--accent--border-color-disabled": "$gray-60",
    ...
    "input--error--border-color-normal": "$gray-80",
    "input--error--border-color-hover": "$error-200",
    "input--error--border-color-focus": "$error-90",
    "input--error--border-color-disabled": "$gray-60",
